...
def startbots():
    def botobj(username, password, speed, accuracy):
        ...
        bot.startBot()
    thread1 = threading.Thread(target=botobj, args=(os.getenv('username1'), os.getenv('password2'), 95, 95))
    thread2 = threading.Thread(target=botobj, args=(os.getenv('username2'), os.getenv('password2'), 85, 95))
    thread3 = threading.Thread(target=botobj, args=(os.getenv('username3'), os.getenv('password2'), 80, 97))
    thread4 = threading.Thread(target=botobj, args=(os.getenv('username4'), os.getenv('password2'), 80, 95))
    thread5 = threading.Thread(target=botobj, args=(os.getenv('username5'), os.getenv('password2'), 120, 96))
    thread6 = threading.Thread(target=botobj, args=(os.getenv('username6'), os.getenv('password6'), 100, 97))
    thread7 = threading.Thread(target=botobj, args=(os.getenv('username7'), os.getenv('password2'), 85, 95))
    thread8 = threading.Thread(target=botobj, args=(os.getenv('username8'), os.getenv('password2'), 85, 95))
    thread9 = threading.Thread(target=botobj, args=(os.getenv('username9'), os.getenv('password2'), 85, 95))
    thread10 = threading.Thread(target=botobj, args=(os.getenv('username10'), os.getenv('password10'), 110, 98))
    thread11 = threading.Thread(target=botobj, args=(os.getenv('username11'), os.getenv('password11'), 220, 100))
    thread12 = threading.Thread(target=botobj, args=(os.getenv('username12'), os.getenv('password12'), 120, 96))
    thread13 = threading.Thread(target=botobj, args=(os.getenv('username13'), os.getenv('password13'), 120, 96))
    thread14 = threading.Thread(target=botobj, args=(os.getenv('username14'), os.getenv('password14'), 100, 96))
    thread15 = threading.Thread(target=botobj, args=(os.getenv('username15'), os.getenv('password15'), 110, 98))
    #thread1.start()
    #thread2.start()
    #thread3.start()
    #thread4.start()
